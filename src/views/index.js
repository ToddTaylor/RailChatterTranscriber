            ...
            for (let i = event.resultIndex; i < event.results.length; i++) {
                ...
                if (event.results[i].isFinal) {
                    ...
                    if (isDetectorCaption(transcript)) {
                        let baseHotboxCaption = spanTowerBroadCastIcon() + directionIcon(transcript) + detectorLocation(transcript) + transcript;
                        ...
                        finalTranscript = '<div id=\'divCaption' + captionCounter + '\'>' + spanWalkieTalkieIcon() + ' ' + transcript + '</div>' + finalTranscript;
                    }
                } else {
...
function spanWalkieTalkieIcon() {
    return spanTimestamp() + ' <i class=\'fa-solid fa-walkie-talkie fa-sm\' title=\'Walkie-Talkie\'></i>';
}
